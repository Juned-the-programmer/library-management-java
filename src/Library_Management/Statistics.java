...
public class Statistics extends javax.swing.JFrame {
    ...
    public void tblissue(){
        try {
            String sql = "select stu_id,book_id,issue_date,actual_date from ISSUE";
    ...
    public void tblreturn(){
        try {
            String sql = "select stu_id,book_id,issue_date,actual_date,return_date from return";
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(738, 503));
